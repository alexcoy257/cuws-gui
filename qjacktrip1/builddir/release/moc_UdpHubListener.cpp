...
QT_MOC_LITERAL(6, 65, 11) // "testReceive"

    },
    "UdpHubListener\0Listening\0\0ClientAddressSet\0"
    "signalRemoveThread\0id\0testReceive"
};
...
void UdpHubListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UdpHubListener *_t = static_cast<UdpHubListener *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject UdpHubListener::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_UdpHubListener.data,
      qt_meta_data_UdpHubListener,  qt_static_metacall, nullptr, nullptr}
};
