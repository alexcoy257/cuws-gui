...
void PacketHeader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PacketHeader *_t = static_cast<PacketHeader *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PacketHeader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PacketHeader.data,
      qt_meta_data_PacketHeader,  qt_static_metacall, nullptr, nullptr}
};
